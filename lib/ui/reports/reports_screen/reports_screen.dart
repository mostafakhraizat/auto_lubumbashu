              ...
              Expanded(
                child: ListView.builder(
                  itemBuilder: (context, index) {
                    if (state.reports.elementAt(index).dnn.contains(input)) {
                      return ListTile(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (c) => PDFScreen(
                                  pdf: File(state.reports.elementAt(index).path),
                                  title: state.reports.elementAt(index).dnn)));
                        },
                        title: SizedBox(
                            ...
                            children: [
                              Builder(
                                  builder: (context) {
                                    ...
                                    return Flexible(
                                      child: Text("#${(state.reports.elementAt(index).dnn)}\n${f.format(DateTime.parse(
                                          state.reports.elementAt(index).date))}",
                        ...
                        subtitle: Text(formatBytes(
                            File(state.reports.elementAt(index).path)
                                .lengthSync(),
                            2)
                            .toString()),
                        trailing: Row(
                          ...
                          children: [
                            InkWell(
                                onTap: () async {
                                  ...
                                  await FlutterShare.shareFile(
                                    title: '#${(state.reports.elementAt(index).dnn).toString()}',
                                    text: 'Share Report',
                            ...
                            //       });
                            //       prefs.setStringList('Reports', reports);
                            //     },
                            //     child: const Icon(
                            //       Icons.delete,
                            //       color: Colors.red,
